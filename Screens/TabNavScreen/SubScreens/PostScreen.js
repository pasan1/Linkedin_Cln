  ...
  uploadImage = async () => {
    ...
    if (this.state.imagePath == undefined) {
      ...
      const videoUrl = await storage()
        .ref(`postVideos/${this.state.videoName}`)
        .getDownloadURL();
      ...
      const imageUrl = await storage()
        .ref(`postImages/${this.state.imageName}`)
        .getDownloadURL();
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView nestedScrollEnabled={true}>
          <View style={styles.view1}>
            ...
            <TouchableOpacity style={styles.btn1} onPress={this.uploadImage}>
          ...
          <View style={styles.view2}>
            <TouchableOpacity
              ...
              <AwesomeIcon
                ...
                size={25}
              />
              <Text style={styles.txt3}>Add a Photo</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.btn2}
              onPress={this.getVideoFromGalery}>
              <AwesomeIcon
                style={styles.icon1}
                color={'#666666'}
                name="video"
                size={25}
              />
              <Text style={styles.txt3}>Take A video</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                ...
                size={25}
              />
              <Text style={styles.txt3}>Celebrate an occasion</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                style={styles.icon1}
                ...
                size={25}
              />
              <Text style={styles.txt3}>Add a Document</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                style={styles.icon1}
                ...
                size={25}
              />
              <Text style={styles.txt3}>Share that you're hiring</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                style={styles.icon1}
                ...
                size={25}
              />
              <Text style={styles.txt3}>Find an expert</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                style={styles.icon1}
                ...
                size={25}
              />
              <Text style={styles.txt3}>Create a poll</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn2}>
              <AwesomeIcon
                style={styles.icon1}
                ...
                size={25}
              />
              <Text style={styles.txt3}>Create an event</Text>
            </TouchableOpacity>
          </View>
